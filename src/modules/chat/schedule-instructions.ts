...
export function buildScheduleInstructions(now: Date, rawTimeZone?: string | null): string {
...
Both timestamps MUST include the user's UTC offset, for example "${exampleTimestamp(now, timeZone, offset)}".
